...
-- Insert data into VerificationCode table with encryption
INSERT INTO VerificationCode (ExpirationDate, EncryptedCode) VALUES
('2024-12-31', ENCRYPTBYKEY(KEY_GUID('MySymmetricKey'), CAST('2024-12-31' AS NVARCHAR(MAX)))),
('2024-12-30', ENCRYPTBYKEY(KEY_GUID('MySymmetricKey'), CAST('2024-12-30' AS NVARCHAR(MAX)))),
('2024-12-29', ENCRYPTBYKEY(KEY_GUID('MySymmetricKey'), CAST('2024-12-29' AS NVARCHAR(MAX)))),
('2024-12-28', ENCRYPTBYKEY(KEY_GUID('MySymmetricKey'), CAST('2024-12-28' AS NVARCHAR(MAX)))),
('2024-12-27', ENCRYPTBYKEY(KEY_GUID('MySymmetricKey'), CAST('2024-12-27' AS NVARCHAR(MAX)))),
('2024-12-26', ENCRYPTBYKEY(KEY_GUID('MySymmetricKey'), CAST('2024-12-26' AS NVARCHAR(MAX)))),
('2024-12-25', ENCRYPTBYKEY(KEY_GUID('MySymmetricKey'), CAST('2024-12-25' AS NVARCHAR(MAX)))),
('2024-12-24', ENCRYPTBYKEY(KEY_GUID('MySymmetricKey'), CAST('2024-12-24' AS NVARCHAR(MAX)))),
('2024-12-23', ENCRYPTBYKEY(KEY_GUID('MySymmetricKey'), CAST('2024-12-23' AS NVARCHAR(MAX)))),
('2024-12-22', ENCRYPTBYKEY(KEY_GUID('MySymmetricKey'), CAST('2024-12-22' AS NVARCHAR(MAX))));
